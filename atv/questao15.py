...
percentualHomens = homensNao / homensTotal * 100

print(f"O número de pessoas que responderam sim: {totalSim}")
print(f"O número de pessoas que responderam não:{totalNao} ")
print(f"O número de mulheres que responderam sim: {mulheresSim}" )
print(f"O percentagem de homens que responderam não, entre homens: {percentualHomens}")